...
$$
\begin{equation}
\frac{MDE_{pilot}}{MDE}=\sqrt{\frac{N}{N_{pilot}}}
\end{equation}
$$

Once we have calculated $MDE_{pilot}$, for a given power and significance level, it is easy to estimate the minimun sample size required in order to reach a goal MDE. Suppose we want to halve the $MDE_{pilot}$, then, keeping constant power and significance, we should quadruple the sample size.
